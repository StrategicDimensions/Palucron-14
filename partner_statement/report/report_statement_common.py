...
class ReportStatementCommon(models.AbstractModel):
    ...
    def _show_buckets_sql_q1(self, partners, date_end, account_type):
        ...
        return str(
            ...
            -- CASE WHEN l.balance > 0.0
            --     CASE WHEN l.debit = 0.0 AND l.credit > 0.0
            ...
            --             CASE
            --                 WHEN l.debit = 0.0 AND l.credit = 0.0
            --                     THEN pd.debit_amount_currency
            --                 WHEN l.credit > 0.0
            --                     THEN pd.credit_amount_currency
            --                 WHEN l.debit > 0.0
            --                     THEN pd.debit_amount_currency
            --             END AS amount_currency
            --         ), 0.0))
            -- ELSE
            --     l.amount_currency + sum(coalesce((
            --             CASE
            --                 WHEN l.debit = 0.0 AND l.credit > 0.0
            --                     THEN pd.credit_amount_currency
            --                 WHEN l.debit > 0.0 AND l.credit = 0.0
            ...
            --                 THEN pd.debit_amount_currency
            --             ELSE 0.0
            --         END AS amount_currency, 0.0))
            --     ELSE l.amount_currency + sum(coalesce(
            --         CASE
            --             WHEN l.debit = 0.0 AND l.credit = 0.0
            --                 THEN pc.credit_amount_currency
            --             WHEN l.credit = 0.0
            --                 THEN pc.credit_amount_currency
            --             WHEN l.debit = 0.0
            --                 THEN pc.credit_amount_currency
